...
public class DataHolder {
    ...
    public static void load() {
        ...
        for (String rawEvent : ALL_RAW_EVENTS) {
            HashEvent hashEvent = HashEvent.fromDto(testEvent(rawEvent));
            events.add(hashEvent);
            eventMap.put(hashEvent.getId(), hashEvent);
        }
    }
    ...
    public static final String[] ALL_RAW_EVENTS = new String[]{RAW_EVENT_1,RAW_EVENT_2,RAW_EVENT_3,RAW_EVENT_4,RAW_EVENT_5,RAW_EVENT_6,RAW_EVENT_7,RAW_EVENT_8,RAW_EVENT_9,RAW_EVENT_10,RAW_EVENT_11,RAW_EVENT_12,RAW_EVENT_13,RAW_EVENT_14,RAW_EVENT_15};
